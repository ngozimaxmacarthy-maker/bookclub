        ...
        <div className="card">
          ...
          {!currentBooks?.length ? (
            ...
            <div className="flex flex-col gap-3">
              {currentBooks.map((book: { id: string; title: string; author: string; avg_rating: number; cover_url: string | null }) => (
                <Link
                  key={book.id}
                  href={`/books/${book.id}`}
                ...
                >
                  <div
                    className="w-10 h-14 rounded flex items-center justify-center flex-shrink-0 overflow-hidden"
